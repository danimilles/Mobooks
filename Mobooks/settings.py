"""
Django settings for Mobooks project.
...
SECRET_KEY = 'django-insecure-xj63-t8)i4a5g@@v!k#w+4o(k4y5=v-&l_b49k8j5*0j!04xb^'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['mobooks.herokuapp.com', 'localhost']
...
WSGI_APPLICATION = 'Mobooks.wsgi.application'
